...
export { default as OligocenoPage }   from './OligocenoPage';

//   Neógeno
export { default as NeogenoPage }     from './NeogenoPage';
export { default as MiocenoPage }     from './MiocenoPage';
export { default as PliocenoPage }    from './PliocenoPage';

//   Cuaternario
export { default as CuaternarioPage }  from './CuaternarioPage';
export { default as PleistocenoPage }  from './PleistocenoPage';
export { default as HolocenoPage }     from './HolocenoPage';