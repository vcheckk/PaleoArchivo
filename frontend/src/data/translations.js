...
export const translations = {
  es: {
    ...
    archivo: {
      ...
      types: {
        ...
        Chondrichthyes:  "Los condictios son peces de esqueleto cartilaginoso, el grupo que incluye tiburones, rayas y quimeras. Con más de 450 millones de años de historia, son uno de los linajes de vertebrados más antiguos y exitosos. Algunos, como el Megalodon, alcanzaron los 18 metros de longitud.",
  ...
  fr: {
    ...
    archivo: {
      diets: {
        "Carnívoro":    "Les carnivores étaient des prédateurs actifs ou des charognards spécialisés. Ils se caractérisaient par des dents acérées, des griffes pour saisir les proies et un métabolisme adapté à la digestion de protéines animales. Ils dominaient le sommet des chaînes alimentaires à travers toutes les ères géologiques.",
        ...
        "Piscívoro":    "Les piscivores étaient spécialisés dans la capture de poissons et d'autres animaux aquatiques. Ils développèrent des mâchoires longues et étroites avec de nombreuses dents coniques pour attraper des proies glissantes, ainsi que des sens adaptés pour détecter les mouvements sous l'eau.",
        "Omnívoro":     "Les omnivores avaient un régime alimentaire flexible combinant matière végétale et animale. Cette polyvalence leur conférait un énorme avantage adaptatif, leur permettant de survivre dans des environnements changeants et d'exploiter des ressources inaccessibles aux autres animaux.",
        "Insectívoro":  "Les insectivores se spécialisaient dans la capture d'arthropodes et d'invertébrés. C'étaient généralement de petits animaux agiles avec des sens aiguisés, des langues collantes ou des griffes adaptées pour creuser. Ils jouaient un rôle clé dans le contrôle des populations d'insectes.",
        "Carroñero":    "Les charognards se nourrissaient principalement de carcasses et de restes d'animaux morts. Loin d'être des opportunistes passifs, beaucoup étaient des compétiteurs agressifs capables de chasser d'autres prédateurs de leurs proies. Leur rôle était essentiel au recyclage des nutriments dans l'écosystème.",
        "Filtrador":    "Les filtreurs extrayaient des micro-organismes et des particules organiques de l'eau ou des sédiments. Ils développèrent des structures spécialisées comme des fanons, des branchies modifiées ou des appendices filtrants. Ils étaient fondamentaux pour le recyclage des nutriments dans les écosystèmes marins.",
        "Detritívoro":  "Les détritivores se nourrissaient de matière organique en décomposition : feuilles mortes, carcasses et sédiments riches en nutriments. Ils agissaient comme les recycleurs de l'écosystème, décomposant la matière complexe et libérant des nutriments dans le sol et l'eau.",
      ...
      types: {
        ...
        Sauropod:        "Les sauropodes furent les plus grands animaux terrestres ayant jamais existé. Leur plan corporel — cou et queue extrêmement longs, corps massif sur quatre colonnes — leur permettait d'atteindre une végétation inaccessible aux autres herbivores. L'Argentinosaurus a pu dépasser les 70 tonnes.",
        ...
        Thyreophoran:    "Les thyréophores étaient des dinosaures ornithischiens protégés par des plaques osseuses, des épines et des boucliers dermiques. Ils comprennent les stégosauridés avec leurs icôniques plaques dorsales, et les ankylosaridés, véritables forteresses ambulantes avec des queues en massue capables de briser des os.",
        ...
        Basal_chordate:  "Les cordés basaux sont les premiers animaux dotés d'une notocorde — précurseur de la colonne vertébrale. Des formes comme Pikaia ou les premiers poissons sans mâchoire représentent les origines de notre propre lignée évolutive, il y a plus de 500 millions d'années.",
        Mollusca:        "Les mollusques sont l'un des phylums animaux les plus diversifiés et les plus anciens. Ils comprennent des céphalopodes éteints comme les ammonites et les bélemnites qui dominèrent les mers mésozoïques, ainsi que de gigantesques nautiloïdes du Paléozoïque.",
        Arthropoda:      "Les arthropodes sont le groupe animal le plus diversifié de l'histoire. Dans la préhistoire, ils comprenaient des scorpions marins dépassant 2 mètres, des insectes géants du Carbonifère comme la libellule Meganeura, et des myriapodes géants comme Arthropleura.",
        Agnatha:         "Les agnathes sont les vertébrés les plus primitifs : des poissons sans mâchoire dont les parents éteints — conodontes et ostéodermes — dominaient les mers de l'Ordovicien et du Dévonien. Leur étude est essentielle pour comprendre les origines de la colonne vertébrale et des mâchoires.",
        Saurischia:      "Les saurischiens sont l'un des deux grands ordres de dinosaures, caractérisés par un pubis pointant vers l'avant. Ils incluent tous les théropodes et sauropodes, ce qui en fait le groupe de dinosaures le plus connu et le plus iconique.",
        Abelisauridae:   "Les abélisauridés étaient des théropodes carnivores qui dominaient les supercontinents de l'hémisphère sud au Crétacé. Ils se caractérisent par des crânes très courts et robustes aux os rugueux et des membres antérieurs extrêmement réduits — encore plus que le T. rex.",
        Squamata:        "Les squamates incluent lézards et serpentes, le groupe de reptiles le plus diversifié aujourd'hui. Au Mésozoïque, ils comprenaient les mosasaures, d'énormes reptiles marins pouvant dépasser 17 mètres et qui dominèrent les océans du Crétacé tardif.",
  ...
  it: {
    ...
    archivo: {
      diets: {
        "Carnívoro":    "I carnivori erano predatori attivi o spazzini specializzati. Si caratterizzavano per denti affilati, artigli per afferrare le prede e un metabolismo adattato a digerire proteine animali. Dominavano la cima delle catene alimentari in tutte le ere geologiche.",
        "Herbívoro":    "Gli erbivori svilupparono adattamenti straordinari per processare la vegetazione dura: denti trituratori a batteria, colli allungati per raggiungere le cime degli alberi o crani bassi per brucare il suolo. Costituivano la maggior parte della biomassa animale negli ecosistemi preistorici.",
        "Piscívoro":    "I piscivori erano specialisti nella cattura di pesci e altri animali acquatici. Svilupparono mascelle lunghe e strette con numerosi denti conici per catturare prede scivolose, oltre a sensi adattati per rilevare movimenti sott'acqua.",
        "Omnívoro":     "Gli onnivori avevano una dieta flessibile che combinava materiale vegetale e animale. Questa versatilità conferiva loro un enorme vantaggio adattivo, permettendo loro di sopravvivere in ambienti mutevoli e sfruttare risorse inaccessibili ad altri animali.",
        "Insectívoro":  "Gli insettivori si specializzarono nella cattura di artropodi e invertebrati. Erano solitamente animali piccoli e agili con sensi acuiti, lingue appiccicose o artigli adattati per scavare. Giocavano un ruolo chiave nel controllo delle popolazioni di insetti.",
        "Carroñero":    "Gli spazzini si nutrivano principalmente di carcasse e resti di animali morti. Lungi dall'essere opportunisti passivi, molti erano competitori aggressivi capaci di allontanare altri predatori dalle loro prede. Il loro ruolo era essenziale per il riciclaggio dei nutrienti nell'ecosistema.",
        "Filtrador":    "I filtratori estraevano micro-organismi e particelle organiche dall'acqua o dai sedimenti. Svilupparono strutture specializzate come fanoni, branchie modificate o appendici filtranti. Erano fondamentali per il riciclaggio dei nutrienti negli ecosistemi marini.",
        "Detritívoro":  "I detritofagi si nutrivano di materia organica in decomposizione: foglie morte, carcasse e sedimenti ricchi di nutrienti. Agivano come i riciclatori dell'ecosistema, decomponendo la materia complessa e rilasciando nutrienti nel suolo e nell'acqua.",
        "Fotosintético": "Gli organismi fotosintetici convertivano l'energia solare in materia organica, costituendo la base di quasi tutte le catene alimentari. In preistoria includevano alghe giganti, piante vascolari primitive e micro-organismi responsabili dell'ossigenazione dell'atmosfera terrestre.",
      },
      types: {
        ...
        Avialae:         "Le avialae comprendono gli uccelli moderni e i loro parenti estinti più prossimi. Si sono evolute da teropodi piumati nel Giurassico e si caratterizzano per ali funzionali, uno scheletro molto leggero e, nelle forme primitive, conservavano ancora denti e artigli alle ali.",
        Thyreophoran:    "I tireofori erano dinosauri ornitischi protetti da placche ossee, spine e scudi dermici. Comprendono gli stegosauridi con le loro iconiche placche dorsali e gli anchilosauridi, vere fortezze ambulanti con code a mazza capaci di rompere le ossa.",
        Plesiosaur:      "I plesiosauri dominarono i mari del Mesozoico per oltre 135 milioni di anni. Si dividevano in due grandi gruppi: le forme a collo lungo e testa piccola (plesiosauroidi) e le forme a collo corto e testa enorme (pliosauridi). Si propellavano con quattro pinne a forma di pagaia.",
        ...
        Basal_arthropod: "Gli artropodi basali includono le forme più primitive di questo phylum, come trilobiti e anomalocaridi. Dominarono i mari del Cambriano e dell'Ordoviciano e rappresentano i primi animali noti con esoscheletro e appendici articolate nel registro fossile.",
        Basal_chordate:  "I cordati basali sono i primi animali con notocorda — precursore della colonna vertebrale. Forme come Pikaia o i primi pesci senza mascella rappresentano le origini del nostro stesso lignaggio evolutivo, oltre 500 milioni di anni fa.",
        Mollusca:        "I molluschi sono uno dei phyla animali più diversificati e antichi. Includono cefalopodi estinti come ammoniti e belemniti che dominarono i mari mesozoici, oltre a giganteschi nautiloidi del Paleozoico. Si caratterizzano per il corpo molle e, in molti casi, un guscio protettivo.",
        Arthropoda:      "Gli artropodi sono il gruppo animale più diversificato della storia. In preistoria includevano scorpioni marini superiori a 2 metri, insetti giganti del Carbonifero come la libellula Meganeura, e miriapodi giganti come Arthropleura.",
        Agnatha:         "Gli agnati sono i vertebrati più primitivi: pesci senza mascella i cui parenti estinti — conodonti e ostracodermi — dominavano i mari dell'Ordoviciano e del Devoniano. Il loro studio è fondamentale per comprendere le origini della colonna vertebrale e delle mascelle.",
        Saurischia:      "I saurischi sono uno dei due grandi ordini di dinosauri, caratterizzati da un pube rivolto in avanti. Includono tutti i teropodi e i sauropodi, il che li rende il gruppo di dinosauri più conosciuto e iconico.",
        Abelisauridae:   "Gli abelisauridi erano teropodi carnivori che dominavano i supercontinenti dell'emisfero meridionale nel Cretaceo. Si caratterizzano per crani molto corti e robusti con ossa rugose e arti anteriori estremamente ridotti — ancora più del T. rex.",
        Squamata:        "Gli squamati includono lucertole e serpenti, il gruppo di rettili più diversificato oggi. Nel Mesozoico comprendevano i mosasauri, enormi rettili marini che potevano superare i 17 metri e dominarono gli oceani del Cretaceo tardivo.",
