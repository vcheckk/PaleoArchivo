      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-6 w-full">
          <div className="space-y-2">
            <label className="text-[12px] tracking-widest ml-5 font-bold uppercase text-stone-500">{lg.userOrEmail}</label>
            <div className="relative">
              ...
              <input 
                ...
                placeholder={lg.userPlaceholder} 
              />
            </div>
          </div>

          <div className="space-y-2">
            <label className="text-[12px] tracking-widest ml-5 font-bold uppercase text-stone-500">{lg.password}</label>
            <div className="relative">
        ...
        <div className={`mt-8 pt-6 border-t-2 w-full text-center ${isLight ? "border-stone-100" : "border-[#3f3833]/70"}`}>
          <p className="text-[14px] text-stone-500 uppercase tracking-widest font-light">
            {lg.noAccount} <Link to="/register" className="text-amber-600 font-bold hover:underline transition-colors">{lg.signUp}</Link>
          </p>
        </div>
      </motion.div>
    </div>
